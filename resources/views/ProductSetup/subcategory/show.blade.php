...
@section('main')
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>Pro. Sub Category</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{url('/')}}">Home</a></li>
                    <li class="breadcrumb-item">Product Setup</li>
                    <li class="breadcrumb-item active">Pro. Sub Category</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <h5 class="card-title">Pro. Sub Category</h5>
                            </div>
                            <div class="col-md-2 mt-3 ">
                                <a href="{{route('ProSubCategory.create')}}" type="button" class="btn btn-outline-success btn-sm text-right"> Add New <i class="bi bi-plus"></i></a>
                            </div>
                        </div>
...
@section('script')
    <script>
        var TableData;
        var url = "{{ route('all.ProSubCategory') }}";
        ...
        function showData(id) {
            var url = "{{ route('ProSubCategory.edit', ':id') }}"; // Use named route with placeholder
