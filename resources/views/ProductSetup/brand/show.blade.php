        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pro. Brand</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-10">
                                <h5 class="card-title">Pro. Brand</h5>
                            </div>
                            <div class="col-md-2 mt-3 ">
                                <a href="{{route('ProBrand.create')}}" type="button" class="btn btn-outline-success btn-sm text-right"> Add New <i class="bi bi-plus"></i></a>
                            </div>
                        </div>
...
@section('script')
    <script>
        ...
        function showData(id) {
            var url = "{{ route('ProBrand.edit', ':id') }}"; // Use named route with placeholder
