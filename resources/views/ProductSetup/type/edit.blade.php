                    ...
                    <div class="card-body" id="addFrom">
                        <div class="row">
                            ...
                            <div class="col-md-2 mt-3 ">
                                <a href="{{url('ProType')}}" type="button" class="btn btn-outline-info btn-sm text-right"> Back <i class="bi bi-arrow-left-short"></i></a>
                            </div>
                        </div>
                        <!-- Multi Columns Form -->
                        <form class="row g-3">
            ...
            success: function (data) {
                ...
                if (dataResult.statusCode == 200) {
                    swal("Success", dataResult.statusMsg).then((result) => {
                            window.location.href = "{{ url('ProType') }}"; // Redirect to a different page
                    });
