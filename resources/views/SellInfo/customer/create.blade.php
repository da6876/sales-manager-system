...
@section('title', '- New Customer Info')
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Customer Info</li>
                </ol>
            </nav>
        </div>
        <!-- End Page Title -->
                    ...
                    <div class="card-body" id="addFrom">
                        <div class="row">
                            ...
                            <div class="col-md-2 mt-3 ">
                                <a href="{{route('customer.index')}}" type="button" class="btn btn-outline-info btn-sm text-right"> Back <i class="bi bi-arrow-left-short"></i></a>
                            </div>
                        </div>
