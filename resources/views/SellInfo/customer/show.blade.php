                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-2 mt-3 ">
                                <a href="{{route('customer.create')}}" type="button" class="btn btn-outline-success btn-sm text-right"> Add New <i class="bi bi-plus"></i></a>
                            </div>
                        </div>
...
@section('script')
    <script>
        ...
        function showData(id) {
            var url = "{{ route('customer.edit', ':id') }}"; // Use named route with placeholder
