...
class ProCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            if ($request['id'] == "") {
                ...
                LogService::log(auth()->user()->id, 'Product Category', 'create', $rowData->getAttributes());
                ...
                LogService::log(auth()->user()->id, 'Product Category', 'update', $navItem->getChanges());
    ...
    public function destroy($id){
        try {
            ...
            LogService::log(auth()->user()->id, 'Product Category', 'delete', $permission->getAttributes());
