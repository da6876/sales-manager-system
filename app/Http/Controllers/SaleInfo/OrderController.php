...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            LogService::log(auth()->user()->id, 'Order', 'create', $order->getAttributes());
            ...
            LogService::log(auth()->user()->id, 'Order Details', 'create', $item);
            ...
            LogService::log(auth()->user()->id, 'Order', 'Failed', $request->all());
