...
class SidebarNavController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            if ($request['id'] == "") {
                ...
                LogService::log(auth()->user()->id, 'Sidebar Nav', 'create', $data->getAttributes());
                ...
                LogService::log(auth()->user()->id, 'Sidebar Nav', 'update', $navItem->getChanges());
    ...
    public function destroy($id)
    {
        try {
            ...
            LogService::log(auth()->user()->id, 'Sidebar Nav', 'delete', $permission->getAttributes());
