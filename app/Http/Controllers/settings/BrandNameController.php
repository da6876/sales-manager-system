...
class BrandNameController extends Controller
{
    ...
    public function store(Request $request)
    {
        try {
            if ($request['id'] == "") {
                ...
                LogService::log(auth()->user()->id, 'Brand Name', 'create', $navItem->getAttributes());
                ...
                LogService::log(auth()->user()->id, 'Brand Name', 'update', $navItem->getChanges());
    ...
    public function destroy($id){
        try {
            ...
            LogService::log(auth()->user()->id, 'Brand Name', 'delete', $permission->getAttributes());
